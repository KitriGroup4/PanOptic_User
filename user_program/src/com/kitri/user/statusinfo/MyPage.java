...
public class MyPage extends JFrame {
	...
	mypgNameLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
	...
	mypgIdLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
	...
	mypgPwLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
	...
	mypgHpLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
	...
	mypgMailLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
	...
	mypgAccuTimeLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
	...
	mypgRestTimeLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
	...
	mypgPointLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
